...
/**
 * Main class for adding a corpus to an existing index (with Lucene)
 * @author HZ
 */
public class AddCorpora2Index
{		
	/**
	 * Adds a corpus to the index 
...
//		Analyzer analyzer = (Analyzer) cls.getDeclaredConstructor(Version.class).newInstance(Version.LUCENE_31);
		...
		manager.index(shingleAnalyzer, reader, indexDir , fields, false, false);
